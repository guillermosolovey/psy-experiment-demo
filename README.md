...
To reduce typing and ensure everyone shares the same session code, distribute a link like:
```
/?session=PSY101
```
The student view will prefill the session code. The dashboard also accepts `?session=PSY101`.
